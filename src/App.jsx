...
import {
  ...
  Phone, Menu, X, Mail, Ruler, Wallet, Filter, Play,
} from "lucide-react";
...
const SITES = [
  ...
  { id: "adj-adjin", ville: "Bingerville", zone: "Abidjan", name: "Bingerville (Adjin)", loc: "Adjin.", surface: "500 m²", cash: "30 000 000 F", echelon: "NON", statut: "Approbation", arg: "Zone Est officiellement désignée du Grand Abidjan par le SDUGA (décret n°2016-138), desservie par la future ligne BRT électrique Yopougon-Bingerville et un chantier de 64,8 milliards FCFA sur le boulevard Mitterrand. À Adjin même, en plein cœur de la zone la plus recherchée de Bingerville.", photo: "/sites/adj-adjin.jpg", video: "" },
  { id: "adj-adoha", ville: "Bingerville", zone: "Abidjan", name: "Bingerville (Adoha)", loc: "Adoha.", surface: "599 m²", cash: "40 000 000 F", echelon: "NON", statut: "ACD globale", arg: "Zone Est officiellement désignée du Grand Abidjan par le SDUGA (décret n°2016-138), desservie par la future ligne BRT électrique Yopougon-Bingerville et un chantier de 64,8 milliards FCFA sur le boulevard Mitterrand. Le plus grand lot du catalogue à Bingerville avec 599 m², une surface rare à ce niveau de secteur.", photo: "/sites/adj-adoha.jpg", video: "" },
  { id: "jacq-djace500", ville: "Jacqueville", zone: "Abidjan", name: "Jacqueville Djacé 500 m²", loc: "En bordure de la route principale de Jacqueville.", surface: "500 m²", cash: "10 000 000 F", echelon: "11 000 000 F sur 6 mois, apport de 5 500 000 F", statut: "Approbation", arg: "Jacqueville est un pôle touristique national prioritaire (stratégie Sublime Côte d'Ivoire, top 5 Afrique d'ici 2030), désenclavé par le pont Philippe-Grégoire-Yacé. En bordure directe de la route principale de Jacqueville, visibilité et accès immédiats.", photo: "/sites/jacq-djace500.jpg", video: "" },
  { id: "jacq-djace407", ville: "Jacqueville", zone: "Abidjan", name: "Jacqueville Djacé 407 m²", loc: "En bordure de la route principale de Jacqueville.", surface: "407 m²", cash: "21 500 000 F", echelon: "22 500 000 F sur 6 mois, apport de 11 000 000 F", statut: "Approbation", arg: "Jacqueville est un pôle touristique national prioritaire (stratégie Sublime Côte d'Ivoire, top 5 Afrique d'ici 2030), désenclavé par le pont Philippe-Grégoire-Yacé. Position en bordure de route également, avec une superficie plus resserrée pour un budget d'entrée différent.", photo: "/sites/jacq-djace407.jpg", video: "" },
  { id: "jacq-ahua", ville: "Jacqueville", zone: "Abidjan", name: "Jacqueville Ahua", loc: "À 10 min du goudron et de la mer, zone habitée, prête à construire, non loin d'une école.", surface: "595 m²", cash: "20 500 000 F", echelon: "NON", statut: "ACD", arg: "Jacqueville est un pôle touristique national prioritaire (stratégie Sublime Côte d'Ivoire, top 5 Afrique d'ici 2030), désenclavé par le pont Philippe-Grégoire-Yacé. À dix minutes à pied de la mer et du goudron, non loin d'une école, idéal pour une résidence familiale.", photo: "/sites/jacq-ahua.jpg", video: "" },
  { id: "jacq-adoumangan", ville: "Jacqueville", zone: "Abidjan", name: "Jacqueville Adoumangan (2e extension)", loc: "À 5 min de la voie principale, carrefour Adoumangan.", surface: "500 m²", cash: "8 500 000 F", echelon: "9 000 000 F sur 6 mois, apport de 3 500 000 F", statut: "Approbation", arg: "Jacqueville est un pôle touristique national prioritaire (stratégie Sublime Côte d'Ivoire, top 5 Afrique d'ici 2030), désenclavé par le pont Philippe-Grégoire-Yacé. Au carrefour même d'Adoumangan, un point de passage qui garantit la visibilité du terrain.", photo: "/sites/jacq-adoumangan.jpg", video: "" },
  { id: "jacq-addah", ville: "Jacqueville", zone: "Abidjan", name: "Jacqueville (Addah)", loc: "Entre lagune, par le village de Tièmé, et mer, par le village Addah.", surface: "400 m²", cash: "4 000 000 F", echelon: "4 500 000 F sur 6 mois, apport de 1 500 000 F", statut: "Attestation villageoise", arg: "Jacqueville est un pôle touristique national prioritaire (stratégie Sublime Côte d'Ivoire, top 5 Afrique d'ici 2030), désenclavé par le pont Philippe-Grégoire-Yacé. Position rare entre lagune et océan, entre les villages de Tièmé et d'Addah, un double accès à l'eau peu courant.", photo: "/sites/jacq-addah.jpg", video: "" },
  { id: "grand-jacque", ville: "Jacqueville", zone: "Abidjan", name: "Grand Jacque", loc: "À 5 km de Jacqueville, près de la maison du sénateur.", surface: "500 m²", cash: "4 000 000 F", echelon: "4 500 000 F sur 24 mois, apport de 1 500 000 F", statut: "Livré avec Titre Foncier", arg: "Jacqueville est un pôle touristique national prioritaire (stratégie Sublime Côte d'Ivoire, top 5 Afrique d'ici 2030), désenclavé par le pont Philippe-Grégoire-Yacé. Déjà livré avec Titre Foncier. Le seul site du secteur de Jacqueville déjà livré avec Titre Foncier, à proximité de la maison du sénateur.", photo: "/sites/grand-jacque.jpg", video: "" },
  { id: "elibou-pk75", ville: "Elibou", zone: "Abidjan", name: "Elibou PK75", loc: "Autoroute du Nord, à moins d'une heure de route d'Abidjan.", surface: "500 m²", cash: "3 500 000 F", echelon: "4 000 000 F sur 6 mois, avance de 1 500 000 F", statut: "Approuvé", arg: "Directement desservi par l'autoroute du Nord, l'axe structurant Abidjan-Yamoussoukro-Bouaké vers le Burkina Faso. Repère kilométrique précis sur l'autoroute du Nord, facile à localiser et à visiter en une sortie.", photo: "/sites/elibou-pk75.jpg", video: "" },
  { id: "elibou-pk78", ville: "Elibou", zone: "Abidjan", name: "Elibou PK78", loc: "1 h de route d'Abidjan, autoroute du Nord, à 200 m du goudron.", surface: "500 m²", cash: "3 000 000 F", echelon: "3 500 000 F sur 6 mois, avance de 1 500 000 F", statut: "En cours d'approbation", arg: "Directement desservi par l'autoroute du Nord, l'axe structurant Abidjan-Yamoussoukro-Bouaké vers le Burkina Faso. 200 m seulement du goudron, l'accès le plus court de tout le corridor Elibou.", photo: "/sites/elibou-pk78.jpg", video: "" },
  { id: "agboville-moutcho", ville: "Agboville", zone: "Abidjan", name: "Agboville (Grand Moutcho)", loc: "À 1 h de route d'Abidjan, à 500 m du goudron.", surface: "400/500 m²", cash: "À partir de 3 500 000 F", echelon: "NON", statut: "Approuvé", arg: "Directement desservi par l'autoroute du Nord, l'axe structurant Abidjan-Yamoussoukro-Bouaké vers le Burkina Faso. Le prix d'entrée le plus bas du secteur d'Agboville, à 500 m du goudron.", photo: "/sites/agboville-moutcho.jpg", video: "" },
  { id: "agboville-ery", ville: "Agboville", zone: "Abidjan", name: "Agboville (Ery Makouguié)", loc: "À 1 h de route d'Abidjan, à moins de 5 min du goudron.", surface: "400 m²", cash: "3 500 000 F", echelon: "4 000 000 F sur 6 mois, apport de 1 500 000 F", statut: "Approuvé", arg: "Directement desservi par l'autoroute du Nord, l'axe structurant Abidjan-Yamoussoukro-Bouaké vers le Burkina Faso. Moins de cinq minutes du goudron, l'accès le plus rapide du secteur Ery Makouguié.", photo: "/sites/agboville-ery.jpg", video: "" },
  { id: "ndouci", ville: "N'Douci", zone: "Abidjan", name: "N'douci", loc: "À 1 h de route d'Abidjan, lots semi-viabilisés.", surface: "500 m²", cash: "4 600 000 F", echelon: "5 000 000 F sur 6 mois, avance de 2 500 000 F", statut: "Approuvé", arg: "Directement desservi par l'autoroute du Nord, l'axe structurant Abidjan-Yamoussoukro-Bouaké vers le Burkina Faso. Lots semi-viabilisés, une longueur d'avance sur la plupart des nouveaux lotissements de la zone.", photo: "/sites/ndouci.jpg", video: "" },

  // YAMOUSSOUKRO
  { id: "pkoupkoussou", ville: "Yamoussoukro", zone: "Yamoussoukro", name: "Pkoupkoussou Golf", loc: "Derrière l'Hôtel du Golf.", surface: "500 m²", cash: "22 000 000 F", echelon: "NON", statut: "ACD", arg: "Capitale politique du pays, structurée par le nouveau Schéma Directeur d'Urbanisme du Grand Yamoussoukro (SDUGY 2040), dévoilé en mars 2024. Juste derrière l'Hôtel du Golf, l'une des adresses les plus centrales du catalogue à Yamoussoukro.", photo: "/sites/pkoupkoussou.jpg", video: "" },
  { id: "dougounou", ville: "Yamoussoukro", zone: "Yamoussoukro", name: "Dougounou Kouadiokro", loc: "À 7 min du centre-ville de Yamoussoukro, sur l'axe Bouaflé.", surface: "600 m²", cash: "3 700 000 F", echelon: "4 200 000 F", statut: "Certificat foncier", arg: "Capitale politique du pays, structurée par le nouveau Schéma Directeur d'Urbanisme du Grand Yamoussoukro (SDUGY 2040), dévoilé en mars 2024. À sept minutes du centre-ville sur l'axe Bouaflé, déjà en Certificat foncier.", photo: "/sites/dougounou.jpg", video: "" },
  { id: "subiakro", ville: "Yamoussoukro", zone: "Yamoussoukro", name: "Yamoussoukro (Subiakro)", loc: "À 7 min du centre-ville.", surface: "500 m²", cash: "3 700 000 F", echelon: "4 200 000 F", statut: "Titre Foncier", arg: "Capitale politique du pays, structurée par le nouveau Schéma Directeur d'Urbanisme du Grand Yamoussoukro (SDUGY 2040), dévoilé en mars 2024. À sept minutes du centre-ville et déjà en Titre Foncier, un rapport sécurité-proximité rare à Yamoussoukro.", photo: "/sites/subiakro.jpg", video: "" },
  { id: "inphb-guiglo", ville: "Yamoussoukro", zone: "Yamoussoukro", name: "INPHB (Lotissement Guiglo)", loc: "Non loin de l'INPHB, à 200 m du siège de l'AGEROUTE.", surface: "500 m²", cash: "22 000 000 F", echelon: "NON", statut: "ACD", arg: "Capitale politique du pays, structurée par le nouveau Schéma Directeur d'Urbanisme du Grand Yamoussoukro (SDUGY 2040), dévoilé en mars 2024. Proche de l'INPHB, siège du pôle universitaire de la ville. À 200 m seulement du siège de l'AGEROUTE, dans un environnement institutionnel stable.", photo: "/sites/inphb-guiglo.jpg", video: "" },
  { id: "gouromlnakro", ville: "Yamoussoukro", zone: "Yamoussoukro", name: "Gouromlnakro", loc: "À 6 km de l'Hôtel Président.", surface: "500 m²", cash: "2 700 000 F", echelon: "NON", statut: "Certificat foncier", arg: "Capitale politique du pays, structurée par le nouveau Schéma Directeur d'Urbanisme du Grand Yamoussoukro (SDUGY 2040), dévoilé en mars 2024. À six kilomètres seulement de l'Hôtel Président, l'un des repères les plus centraux de la ville.", photo: "/sites/gouromlnakro.jpg", video: "" },
  { id: "lolobo-ext", ville: "Yamoussoukro", zone: "Yamoussoukro", name: "Lolobo Extension", loc: "À 10 km de Yamoussoukro, sur l'ancienne voie de Bouaké.", surface: "600 m²", cash: "2 700 000 F", echelon: "NON", statut: "ACD global en cours", arg: "Capitale politique du pays, structurée par le nouveau Schéma Directeur d'Urbanisme du Grand Yamoussoukro (SDUGY 2040), dévoilé en mars 2024. Sur l'ancienne voie de Bouaké, une zone d'extension qui profite du désengorgement de l'axe principal.", photo: "/sites/lolobo-ext.jpg", video: "" },
  { id: "mahounou", ville: "Yamoussoukro", zone: "Yamoussoukro", name: "Mahounou", loc: "À 10 km, derrière l'aéroport de Yamoussoukro.", surface: "500 m²", cash: "3 700 000 F", echelon: "4 200 000 F", statut: "Attestation villageoise", arg: "Capitale politique du pays, structurée par le nouveau Schéma Directeur d'Urbanisme du Grand Yamoussoukro (SDUGY 2040), dévoilé en mars 2024. Juste derrière l'aéroport de Yamoussoukro, une localisation stratégique pour tout projet lié au transport.", photo: "/sites/mahounou.jpg", video: "" },
  { id: "bazre", ville: "Yamoussoukro", zone: "Yamoussoukro", name: "Bazré", loc: "Axe Yamoussoukro–Sinfra, à 500 m de la voie principale.", surface: "500 m²", cash: "2 700 000 F", echelon: "NON", statut: "Approuvé", arg: "Capitale politique du pays, structurée par le nouveau Schéma Directeur d'Urbanisme du Grand Yamoussoukro (SDUGY 2040), dévoilé en mars 2024. À 500 m seulement de la voie principale Yamoussoukro-Sinfra, un accès direct sans détour.", photo: "/sites/bazre.jpg", video: "" },
  { id: "menou1", ville: "Yamoussoukro", zone: "Yamoussoukro", name: "Menou 1", loc: "À 16 km de Yamoussoukro, sur l'autoroute du Nord, axe Bouaké.", surface: "500 m²", cash: "2 700 000 F", echelon: "3 200 000 F sur 6 mois", statut: "Titre Foncier", arg: "Capitale politique du pays et situé directement sur l'autoroute du Nord, axe Bouaké, déjà en Titre Foncier. Prix d'entrée parmi les plus bas de l'axe autoroutier, déjà sécurisé par un Titre Foncier.", photo: "/sites/menou1.jpg", video: "" },
  { id: "ndebo", ville: "Yamoussoukro", zone: "Yamoussoukro", name: "N'debo", loc: "À 17 km de Yamoussoukro.", surface: "500 m²", cash: "1 000 000 F", echelon: "NON", statut: "Certificat foncier", arg: "Capitale politique du pays, structurée par le nouveau Schéma Directeur d'Urbanisme du Grand Yamoussoukro (SDUGY 2040), dévoilé en mars 2024. Le prix le plus bas de tout le secteur de Yamoussoukro, à 1 000 000 F cash.", photo: "/sites/ndebo.jpg", video: "" },
  { id: "lolobo-ndenou", ville: "Yamoussoukro", zone: "Yamoussoukro", name: "Yamoussoukro (Lolobo N'denou)", loc: "À 21 min de Yamoussoukro, en bordure de l'autoroute, axe Bouaké.", surface: "500 m²", cash: "3 700 000 F", echelon: "4 200 000 F", statut: "Titre Foncier", arg: "Capitale politique du pays et situé directement sur l'autoroute du Nord, axe Bouaké, déjà en Titre Foncier. En bordure directe de l'autoroute, visibilité maximale pour un usage commercial ou résidentiel.", photo: "/sites/lolobo-ndenou.jpg", video: "" },

  // BOUAKE ET PERIPHERIE
  { id: "belleville", ville: "Bouaké", zone: "Bouaké", name: "Belleville Ankoprikro", loc: "Extension du quartier Belleville 02, derrière Kanankro, à 5 km de la voie bitumée.", surface: "400 m²", cash: "1 200 000 F", echelon: "1 500 000 F sur 6 mois, avance de 500 000 F", statut: "Certificat foncier", arg: "Couvert par le Plan d'Urbanisme de Détail de Bouaké (2020-2022), qui structure les zones d'extension de la 2e ville et 3e pôle économique du pays, notée BBB par Bloomfield Investment Corporation. Quartier explicitement identifié comme propice aux projets de résidences, à 5 km de la voie bitumée.", photo: "/sites/belleville.jpg", video: "" },
  { id: "okaville", ville: "Bouaké", zone: "Bouaké", name: "Okaville", loc: "Après N'dakro, donnant sur l'autoroute, 600 hectares lotis, près de la zone industrielle de Bouaké.", surface: "500 m²", cash: "3 200 000 F", echelon: "3 500 000 F sur 6 mois, avance de 1 500 000 F", statut: "Approuvé", arg: "Couvert par le Plan d'Urbanisme de Détail de Bouaké (2020-2022), qui structure les zones d'extension de la 2e ville et 3e pôle économique du pays, notée BBB par Bloomfield Investment Corporation. Adossé aux 600 hectares de la zone industrielle de Bouaké. 600 hectares déjà lotis donnant directement sur l'autoroute, l'un des plus grands lotissements du corridor Nord.", photo: "/sites/okaville.jpg", video: "" },
  { id: "assaplissi", ville: "Bouaké", zone: "Bouaké", name: "Assaplissi Dinambo", loc: "Extension du quartier Tchelekro, site prêt à construire.", surface: "500 m²", cash: "1 800 000 F", echelon: "2 000 000 F sur 10 mois, avance de 1 000 000 F", statut: "Nouveau Lotissement", arg: "Couvert par le Plan d'Urbanisme de Détail de Bouaké (2020-2022), qui structure les zones d'extension de la 2e ville et 3e pôle économique du pays, notée BBB par Bloomfield Investment Corporation. Site déjà habité et prêt à construire, décrit comme propice à une vie paisible.", photo: "/sites/assaplissi.jpg", video: "" },
  { id: "kondoubo-mirador", ville: "Bouaké", zone: "Bouaké", name: "Kondoubo – Cité Mirador", loc: "Après l'échangeur de Diabo, derrière la cité CIDT et une usine d'anacarde.", surface: "500 m²", cash: "1 200 000 F", echelon: "1 500 000 F sur 6 mois, avance de 700 000 F", statut: "Nouveau Lotissement", arg: "Couvert par le Plan d'Urbanisme de Détail de Bouaké (2020-2022), qui structure les zones d'extension de la 2e ville et 3e pôle économique du pays, notée BBB par Bloomfield Investment Corporation. Adossé à une usine d'anacarde active, une garantie de dynamique économique locale immédiate.", photo: "/sites/kondoubo-mirador.jpg", video: "" },
  ...
  { id: "allokokro", ville: "Bouaké", zone: "Bouaké", name: "Allokokro Ext", loc: "Derrière la cité CIDT, sur la route de Diabo.", surface: "500 m²", cash: "3 500 000 F (cash uniquement)", echelon: "3 700 000 F en échelons, frais d'enregistrement inclus", statut: "Approuvé", arg: "Couvert par le Plan d'Urbanisme de Détail de Bouaké (2020-2022), qui structure les zones d'extension de la 2e ville et 3e pôle économique du pays, notée BBB par Bloomfield Investment Corporation. Possibilité de transformer le dossier en ACD, une option rare parmi les lots à ce prix.", photo: "/sites/allokokro.jpg", video: "" },
  { id: "pokoukro", ville: "Bouaké", zone: "Bouaké", name: "Pokoukro", loc: "Quartier Pokoukro, Bouaké.", surface: "500 m²", cash: "600 000 F", echelon: "750 000 F sur 6 mois", statut: "Nouveau Lotissement", arg: "Couvert par le Plan d'Urbanisme de Détail de Bouaké (2020-2022), qui structure les zones d'extension de la 2e ville et 3e pôle économique du pays, notée BBB par Bloomfield Investment Corporation. 30 lots seulement disponibles en promotion ce mois-ci, le stock le plus limité du catalogue actuellement.", photo: "/sites/pokoukro.jpg", promo: { cash: "450 000 F", echelon: "650 000 F sur 6 mois", until: "2026-09-30", lots: 30 }, video: "" },
  { id: "assieblenou", ville: "Béoumi", zone: "Bouaké", name: "Assieblenou", loc: "Village à 8 km de l'échangeur de Béoumi, sur l'axe Béoumi.", surface: "500 m²", cash: "1 000 000 F", echelon: "1 200 000 F sur 6 mois, avance de 500 000 F", statut: "Nouveau Lotissement", arg: "Sur l'axe Béoumi-Sakassou-Tiébissou, actuellement en cours de bitumage par l'État. À seulement 8 km de l'échangeur de Béoumi, un accès rapide malgré la position rurale.", photo: "/sites/assieblenou.jpg", video: "" },
  { id: "angouayaokro", ville: "Bouaké", zone: "Bouaké", name: "Angouayaokro", loc: "À 10 km de Bouaké, proche de la SODECI Loka.", surface: "500 m²", cash: "1 000 000 F", echelon: "1 200 000 F sur 6 mois", statut: "Nouveau Lotissement", arg: "Couvert par le Plan d'Urbanisme de Détail de Bouaké (2020-2022), qui structure les zones d'extension de la 2e ville et 3e pôle économique du pays, notée BBB par Bloomfield Investment Corporation. Voisin direct de la SODECI Loka, décrit comme propice à une vie paisible.", photo: "/sites/angouayaokro.jpg", video: "" },
  { id: "diabo", ville: "Bouaké", zone: "Bouaké", name: "Diabo", loc: "À 10 km de Bouaké, derrière le collège Mohayet.", surface: "500 m²", cash: "700 000 F", echelon: "900 000 F sur 6 mois, avance de 500 000 F", statut: "Approuvé", arg: "Couvert par le Plan d'Urbanisme de Détail de Bouaké (2020-2022), qui structure les zones d'extension de la 2e ville et 3e pôle économique du pays, notée BBB par Bloomfield Investment Corporation. Le prix le plus bas de tout le secteur de Bouaké, à 700 000 F cash, derrière le collège Mohayet.", photo: "/sites/diabo.jpg", video: "" },
  { id: "diabo-selakro", ville: "Bouaké", zone: "Bouaké", name: "Diabo Selakro", loc: "Quartier résidentiel de Diabo, en face du Trésor, à 300 m du goudron.", surface: "500 m²", cash: "1 200 000 F", echelon: "1 500 000 F sur 6 mois, avance de 500 000 F", statut: "Nouveau Lotissement", arg: "Couvert par le Plan d'Urbanisme de Détail de Bouaké (2020-2022), qui structure les zones d'extension de la 2e ville et 3e pôle économique du pays, notée BBB par Bloomfield Investment Corporation. Face au Trésor de Diabo, à seulement 300 m du goudron, un emplacement central.", photo: "/sites/diabo-selakro.jpg", video: "" },
  { id: "bessielikro", ville: "Katiola", zone: "Bouaké", name: "Bessielikro 1", loc: "À 10 km de Bouaké, rond-point de l'échangeur de Katiola, corridor Nord.", surface: "500 m²", cash: "1 500 000 F", echelon: "1 800 000 F sur 10 mois, avance de 800 000 F", statut: "Nouveau Lotissement", arg: "Sur l'axe du chantier autoroutier Bouaké-Kanawolo (près de 70 km), qui prolonge la dynamique de l'autoroute du Nord arrivée à Bouaké en 2023. Décrit comme propice à l'entrepreneuriat, au rond-point même de l'échangeur de Katiola.", photo: "/sites/bessielikro.jpg", video: "" },
  { id: "bamoro", ville: "Bouaké", zone: "Bouaké", name: "Bamoro", loc: "Extension de Bouaké, corridor Nord, zone à fort potentiel industriel.", surface: "500 m²", cash: "1 500 000 F", echelon: "1 800 000 F sur 6 mois, avance de 800 000 F", statut: "Certificat foncier", arg: "Sur l'axe du chantier autoroutier Bouaké-Kanawolo (près de 70 km), qui prolonge la dynamique de l'autoroute du Nord arrivée à Bouaké en 2023. Zone explicitement identifiée à fort potentiel industriel sur le corridor Nord de Bouaké.", photo: "/sites/bamoro.jpg", video: "" },
  { id: "kimoukro", ville: "Béoumi", zone: "Bouaké", name: "Kimoukro", loc: "Route de Béoumi, à 1 km de la base SODECI et PFO.", surface: "500 m²", cash: "1 500 000 F", echelon: "1 800 000 F sur 6 mois, avance de 500 000 F", statut: "Certificat foncier", arg: "Sur l'axe Béoumi-Sakassou-Tiébissou, actuellement en cours de bitumage par l'État. Lots en bordure de route, à 1 km seulement de la base SODECI et PFO.", photo: "/sites/kimoukro.jpg", video: "" },
  { id: "allakro", ville: "Katiola", zone: "Bouaké", name: "Allakro", loc: "Site à 20 km de Bouaké, sur la route de Katiola.", surface: "600 m²", cash: "1 500 000 F", echelon: "1 800 000 F sur 6 mois, avance de 800 000 F (frais inclus)", statut: "Titre Foncier", arg: "Sur l'axe du chantier autoroutier Bouaké-Kanawolo (près de 70 km), qui prolonge la dynamique de l'autoroute du Nord arrivée à Bouaké en 2023. Déjà en Titre Foncier, le meilleur niveau de sécurité foncière. Le seul site du corridor Katiola déjà en Titre Foncier, le niveau de sécurité maximal.", photo: "/sites/allakro.jpg", video: "" },
  { id: "brobo", ville: "Bouaké", zone: "Bouaké", name: "Brobo Ktier Royale", loc: "Quartier résidentiel de Brobo, à 20 km de Bouaké (Est).", surface: "600 m²", cash: "1 200 000 F", echelon: "1 500 000 F sur 6 mois, avance de 600 000 F", statut: "Nouveau Lotissement", arg: "Ticket d'entrée parmi les plus bas du catalogue, dans la zone d'influence du PND 2026-2030 pour la région du Gbêkê, avec 118 millions $ de financement UE pour la mobilité et le développement du Nord. Site déjà habité et prêt à construire, dans un quartier résidentiel établi de Brobo.", photo: "/sites/brobo.jpg", video: "" },
  { id: "kpelebonou", ville: "Sakassou", zone: "Bouaké", name: "Kpelebonou", loc: "Route de Sakassou, entre Bendekouassikro et Pitiéssi. Projet de logements sociaux prévu sur le site.", surface: "500 m²", cash: "1 800 000 F", echelon: "2 000 000 F sur 6 mois, avance de 800 000 F", statut: "En cours d'approbation", arg: "Sur l'axe Béoumi-Sakassou-Tiébissou, actuellement en cours de bitumage par l'État. Un projet de logements sociaux est prévu sur le site. Un projet de logements sociaux est déjà prévu sur ce site même par les autorités locales.", photo: "/sites/kpelebonou.jpg", video: "" },
  { id: "akabroukro", ville: "Bouaké", zone: "Bouaké", name: "Akabroukro", loc: "Premier village de la région de l'Iffou, à 45 km de Bouaké.", surface: "600 m²", cash: "500 000 F", echelon: "700 000 F sur 6 mois, avance de 200 000 F", statut: "Nouveau Lotissement", arg: "Ticket d'entrée parmi les plus bas du catalogue, dans la zone d'influence du PND 2026-2030 pour la région du Gbêkê, avec 118 millions $ de financement UE pour la mobilité et le développement du Nord. Le prix d'entrée le plus bas de tout le catalogue, à 500 000 F cash.", photo: "/sites/akabroukro.jpg", video: "" },
  { id: "fronan", ville: "Katiola", zone: "Bouaké", name: "Fronan", loc: "À 7 km de Katiola, 64 km de Bouaké, 50 lots disponibles.", surface: "500 m²", cash: "500 000 F", echelon: "750 000 F sur 6 mois, avance de 250 000 F", statut: "Approuvé", arg: "Sur l'axe du chantier autoroutier Bouaké-Kanawolo (près de 70 km), qui prolonge la dynamique de l'autoroute du Nord arrivée à Bouaké en 2023. 50 lots disponibles au même endroit, une réserve foncière rare à ce niveau de prix.", photo: "/sites/fronan.jpg", video: "" },
  { id: "agbahou", ville: "Kounahiri", zone: "Bouaké", name: "Agbahou (Kounahiri)", loc: "À 25 km de Béoumi, 5 km de Kounahiri, 100 lots disponibles.", surface: "500 m²", cash: "800 000 F", echelon: "1 000 000 F sur 6 mois, avance de 400 000 F", statut: "Nouveau Lotissement", arg: "Ticket d'entrée parmi les plus bas du catalogue, dans la zone d'influence du PND 2026-2030 pour la région du Gbêkê, avec 118 millions $ de financement UE pour la mobilité et le développement du Nord. 100 lots disponibles sur un même site, la plus grande réserve foncière du catalogue.", photo: "/sites/agbahou.jpg", video: "" },
];
...
function waLink(site) {
  const msg = "Bonjour, je suis intéressé par le site " + site.name + " (" + site.ville + "). Pouvez-vous m'en dire plus ?";
...
function SiteCard({ site }) {
  ...
  const hasVideo = site.video && site.video.trim() !== "";
  return (
    <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden hover:shadow-lg transition-shadow duration-300 flex flex-col">
      <div className="h-32 bg-gradient-to-br from-[#1F4E79] to-[#173d5f] flex items-center justify-center relative">
        ...
        />
        <span className="absolute top-3 left-3 text-[10px] font-bold tracking-widest uppercase text-white/80 z-10 drop-shadow">{site.ville}</span>
      ...
      <div className="p-5 flex flex-col flex-1">
        ...
        {hasVideo && showVideo && (
          <div className="mb-3 rounded-lg overflow-hidden aspect-video bg-black">
            <iframe
              src={"https://www.youtube.com/embed/" + site.video + "?autoplay=1"}
              title={"Vidéo " + site.name}
        ...
        <div className="flex gap-2">
          {hasVideo && (
            <button
              ...
              className="mt-2 inline-flex items-center justify-center gap-1.5 bg-white border border-[#1F4E79] text-[#1F4E79] text-sm font-semibold rounded-full px-4 py-2.5 hover:bg-[#F7FAFD] transition-colors"
            >
              <Play className="w-3.5 h-3.5" /> {showVideo ? "Fermer" : "Vidéo"}
            </button>
          )}
          <a
            href={waLink(site)}
            className="mt-2 flex-1 inline-flex items-center justify-center gap-2 bg-[#1F4E79] text-white text-sm font-semibold rounded-full px-4 py-2.5 hover:bg-[#163b5c] transition-colors"
          >
